...
/**
 * Modela un objeto geom�trico que est� situado en una posici�n de un espacio de dos 
...
public interface IForma {
	 ...
	 *         La clase debe definir si el m�todo
	 *         gira al objeto receptor del mensaje o se crea un nuevo objeto resultado
	 *         de girar al objeto sobre el que se invoca el m�todo.
	 */
	 ...
	 *         de trasladar al objeto sobre el que se invoca el m�todo.
	 */
	 ...
	 * La distancia debe calcularse respecto de los puntos definidos por los m�todos getX y getY
	 * de ambos objetos.
