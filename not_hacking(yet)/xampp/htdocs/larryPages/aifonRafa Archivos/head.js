...
for(var f=0;f<d.length;f++){c(d[f])}return c}({1:[function(c,d,b){var a=function a(){var h="";
...
}return f}}},{}],3:[function(f,d,h){var a=f("./shared/stylePropertyCache");var i=f("./shared/getStyleTestElement");
...
}return c(p,n[m])}}return c(p,false)}},{"./shared/getStyleTestElement":5,"./shared/prefixHelper":6,"./shared/stylePropertyCache":7,"./utils/toCSS":9,"./utils/toDOM":10}],4:[function(d,b,h){var f=d("./getStyleProperty");
...
}},{"./getStyleProperty":3,"./shared/prefixHelper":6,"./shared/stylePropertyCache":7,"./shared/styleValueAvailable":8}],5:[function(c,d,b){var f;
d.exports=function a(){if(!f){f=document.createElement("_")}else{f.style.cssText="";
f.removeAttribute("style")}return f};d.exports.resetElement=function(){f=null}},{}],6:[function(b,d,a){var i=["-webkit-","-moz-","-ms-"];
...
this.dom=[this.dom[j]];this.evt=[this.evt[j]]}};d.exports=new c()},{}],7:[function(b,c,a){c.exports={}
},{}],8:[function(c,b,d){var a=c("./stylePropertyCache");var f=c("./getStyleTestElement");
...
}},{"./getStyleTestElement":5,"./stylePropertyCache":7}],9:[function(c,d,b){var f=/^(webkit|moz|ms)/gi;
...
}},{}],10:[function(b,c,a){var f=/-([a-z])/g;c.exports=function d(h){var g;if(h.toLowerCase()==="float"){return"cssFloat"
}h=h.replace(f,function(j,i){return i.toUpperCase()});if(h.substr(0,2)==="Ms"){h="ms"+h.substring(2)
}return h}},{}],11:[function(b,c,a){var g=b("./helpers/globals");var f=b("@marcom/ac-function/once");
var d=function d(){var h=g.getDocument();var i=h.createElement("canvas");return !!(typeof i.getContext==="function"&&i.getContext("2d"))
};c.exports=f(d);c.exports.original=d},{"./helpers/globals":13,"@marcom/ac-function/once":2}],12:[function(c,d,b){var g=c("@marcom/ac-prefixer/getStyleValue");
...
d.exports.original=a},{"@marcom/ac-function/memoize":1,"@marcom/ac-prefixer/getStyleProperty":3,"@marcom/ac-prefixer/getStyleValue":4}],13:[function(b,d,a){d.exports={getWindow:function c(){return window
},getDocument:function f(){return document},getNavigator:function g(){return navigator
}}},{}],14:[function(d,f,b){var a=d("./touchAvailable").original;var h=d("./helpers/globals");
var g=d("@marcom/ac-function/once");function c(){var i=h.getWindow();return !a()&&!i.orientation
}f.exports=g(c);f.exports.original=c},{"./helpers/globals":13,"./touchAvailable":17,"@marcom/ac-function/once":2}],15:[function(c,d,b){var g=c("./helpers/globals");
...
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":13,"@marcom/ac-function/once":2}],16:[function(b,c,a){var g=b("@marcom/ac-prefixer/getStyleValue");
var d=b("@marcom/ac-function/once");function f(){return !!(g("perspective","1px")&&g("transform","translateZ(0)"))
}c.exports=d(f);c.exports.original=f},{"@marcom/ac-function/once":2,"@marcom/ac-prefixer/getStyleValue":4}],17:[function(c,d,b){var g=c("./helpers/globals");
var f=c("@marcom/ac-function/once");function a(){var j=g.getWindow();var h=g.getDocument();
var i=g.getNavigator();return !!("ontouchstart" in j||j.DocumentTouch&&h instanceof j.DocumentTouch||i.maxTouchPoints>0||i.msMaxTouchPoints>0)
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":13,"@marcom/ac-function/once":2}],18:[function(d,f,b){var g=d("./ac-browser/BrowserData");
...
if(c.name==="IE"){c.IE={documentMode:h.getDocumentMode()}}f.exports=c},{"./ac-browser/BrowserData":19,"./ac-browser/IE":20}],19:[function(f,c,j){f("@marcom/ac-polyfills/Array/prototype.filter");
...
};c.exports=l},{"./data":21,"@marcom/ac-polyfills/Array/prototype.filter":"@marcom/ac-polyfills/Array/prototype.filter","@marcom/ac-polyfills/Array/prototype.some":"@marcom/ac-polyfills/Array/prototype.some"}],20:[function(b,d,a){d.exports={getDocumentMode:function c(){var f;
...
return}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":23,"@marcom/ac-polyfills/Array/prototype.slice":"@marcom/ac-polyfills/Array/prototype.slice","@marcom/ac-polyfills/Element/prototype.classList":"@marcom/ac-polyfills/Element/prototype.classList"}],23:[function(b,c,a){var d=b("./contains");
...
},{"@marcom/ac-browser":18,"@marcom/ac-feature/svgAvailable":15,"@marcom/ac-feature/touchAvailable":17}],32:[function(c,d,b){c("@marcom/ac-polyfills/Array/prototype.forEach");
...
}},{}],52:[function(c,a,f){c("@marcom/ac-polyfills");var g=c("@marcom/ac-headjs");
var i=c("@marcom/ac-feature/cssPropertyAvailable");var h=c("./shared/model/inlineVideoAutoplaySupported");
var k=c("@marcom/ac-feature/threeDTransformsAvailable");var d=c("./shared/helpers/isFallbackGPU");
var l=c("@marcom/ac-useragent");var b=window.matchMedia("(prefers-reduced-motion)").matches;
var j=function(){return{initialize:function m(){g.addTests({"anim-system":k(),"inline-video":j.canPlayInlineVideo(),"inline-video-autoplay":h(),"css-sticky":i("position","sticky"),"fallback-gpu":d,"high-gpu":!b&&!d,"reduced-motion":b,parallax:false,"ios-11":l.os.ios&&l.os.version.major===11});
g.htmlClass()},canPlayInlineVideo:function n(){var p=c("@marcom/ac-feature/isDesktop");
var r=c("@marcom/ac-feature/canvasAvailable");var o=l.os.ios&&l.os.version.major>9;
var q=[p()||o,r()];return q.indexOf(false)===-1}}}();a.exports=j.initialize()},{"./shared/helpers/isFallbackGPU":54,"./shared/model/inlineVideoAutoplaySupported":55,"@marcom/ac-feature/canvasAvailable":11,"@marcom/ac-feature/cssPropertyAvailable":12,"@marcom/ac-feature/isDesktop":14,"@marcom/ac-feature/threeDTransformsAvailable":16,"@marcom/ac-headjs":30,"@marcom/ac-polyfills":"@marcom/ac-polyfills","@marcom/ac-useragent":47}],53:[function(c,d,b){d.exports=function a(){var f=null;
...
},{}],54:[function(c,d,b){var a=c("./getGPU");d.exports=function f(){var g=a();
return g.indexOf("Apple A7")>-1||g.indexOf("Apple A8 GPU")>-1}()},{"./getGPU":53}],55:[function(b,c,a){c.exports=function(){var d=b("@marcom/ac-useragent");
